...
export function AuthPage() {
  ...
  const submit = async (event: React.FormEvent) => {
    ...
    try {
      ...
      const auth = register ? await authApi.register(email, password) : await authApi.login(email, password);
      setSession(auth);
