...
public interface ILabelService
{
    ...
    Task<ServiceResult> UpdateLabelAsync(int projectId, int labelId, UpdateLabelRequest request, CancellationToken cancellationToken);
    Task<ServiceResult> DeleteLabelAsync(int projectId, int labelId, CancellationToken cancellationToken);
