        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuggestedPriority = table.Column<string>(type: "text", nullable: true),
                    SuggestedLabels = table.Column<string>(type: "text", nullable: true),
                    SuggestedSubtasks = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AiSuggestions_TaskItems_TaskId",
                        column: x => x.TaskId,
                        principalTable: "TaskItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_AiSuggestions_Users_RequestedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AiSuggestions_RequestedByUserId",
                table: "AiSuggestions",
