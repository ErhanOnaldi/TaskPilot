...
{
    /// <inheritdoc />
    public partial class AddPersistentReportScheduling : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql("""
                UPDATE "WeeklyReportSchedules" AS schedule
                SET "RequestedByUserId" = project."CreatedByUserId"
                FROM "Projects" AS project
                WHERE schedule."ProjectId" = project."Id"
                  AND schedule."RequestedByUserId" = 0;
                ALTER TABLE "WeeklyReportSchedules" ALTER COLUMN "RequestedByUserId" DROP DEFAULT;
                """);

            migrationBuilder.CreateIndex(
                name: "IX_WeeklyReportSchedules_RequestedByUserId",
                table: "WeeklyReportSchedules",
                column: "RequestedByUserId");

            migrationBuilder.AddForeignKey(
                name: "FK_WeeklyReportSchedules_Users_RequestedByUserId",
                table: "WeeklyReportSchedules",
                column: "RequestedByUserId",
            ...
            migrationBuilder.Sql("""
                CREATE TABLE qrtz_job_details (
                    ...
                    description TEXT NULL, job_class_name TEXT NOT NULL, is_durable BOOL NOT NULL,
                    is_nonconcurrent BOOL NOT NULL, is_update_data BOOL NOT NULL,
                    requests_recovery BOOL NOT NULL, job_data BYTEA NULL,
                ...
                CREATE TABLE qrtz_simprop_triggers (
                    ...
                    dec_prop_1 NUMERIC NULL, dec_prop_2 NUMERIC NULL,
                ...
                CREATE TABLE qrtz_cron_triggers (
                    sched_name TEXT NOT NULL, trigger_name TEXT NOT NULL, trigger_group TEXT NOT NULL,
                    cron_expression TEXT NOT NULL, time_zone_id TEXT,
                    PRIMARY KEY (sched_name, trigger_name, trigger_group),
                    FOREIGN KEY (sched_name, trigger_name, trigger_group)
                        REFERENCES qrtz_triggers (sched_name, trigger_name, trigger_group) ON DELETE CASCADE);
                ...
                CREATE TABLE qrtz_blob_triggers (
                    sched_name TEXT NOT NULL, trigger_name TEXT NOT NULL, trigger_group TEXT NOT NULL,
                    blob_data BYTEA NULL, PRIMARY KEY (sched_name, trigger_name, trigger_group),
                    FOREIGN KEY (sched_name, trigger_name, trigger_group)
                        REFERENCES qrtz_triggers (sched_name, trigger_name, trigger_group) ON DELETE CASCADE);
                ...
                CREATE TABLE qrtz_fired_triggers (
                    ...
                    requests_recovery BOOL NULL, execution_group VARCHAR(200) NULL,
                    PRIMARY KEY (sched_name, entry_id));

                CREATE TABLE qrtz_scheduler_state (
                    sched_name TEXT NOT NULL, instance_name TEXT NOT NULL,
